...
public class OsController {
    ...
    public ResponseEntity<Page<OsResponse>> getByDone(@PageableDefault(size = 10, page = 0, sort = "client") Pageable pageable) {
        return ResponseEntity.ok(osService.getByDone(pageable));
    }
